package config
type DB struct {
	Disable     bool   `structure:"disable" json:"disable" yaml:"disable"`
	Type        string `structure:"type" json:"type" yaml:"type"`
	AliasName   string `structure:"alias-name" json:"alias-name" yaml:"alias-name"`
	Path        string `structure:"path" json:"path" yaml:"path"`                             // 服务器地址:端口
	...
	LogZap      bool   `structure:"log-zap" json:"logZap" yaml:"log-zap"`
}
